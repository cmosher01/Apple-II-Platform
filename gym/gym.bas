 ...
 12  VTAB 4: HTAB 10: ? A$;: VTAB 6: HTAB 14: ? B$;: VTAB 9: HTAB 20: ? "BY";: VTAB 12: HTAB 14: ? "RICK" SPC( 5)"CHRIS";: VTAB 13: HTAB 19: ? "AND";: VTAB 14: HTAB 13: ? "LEWIS" SPC( 5)"MOSHER": VTAB 16: HTAB 17: ? "M.P.H.S.": GOSUB 10100
 ...
 4025  VTAB 18: HTAB 16: ? "<-- - PREVIOUS": HTAB 16: ? "--> - NEXT": VTAB 21: HTAB 13: PRINT "ENTER SCORE WHEN": HTAB 13: PRINT "APPROPRIATE EVENT": HTAB 13: ? "IS HIGHLIGHTED": VTAB 8: HTAB 12:E = 1
 ...
 5000 NS = 2:SL$(1)="CLASS/EVENT":SL$(2)="ALL SCORES":TL$="PRINT SCORES": GOSUB 10000:P = S:SL$(1) = "SCREEN":SL$(2) = "PRINTER":TL$ = "": GOSUB 10000: ?D$"PR#"S - 1:SC = (S = 1): GOSUB 20000: ON P GOSUB 5100,5440:TEXT:?D$"PR#0": RETURN 
 ...
 5250  IFNOTSCAND((E=1ANDFX(P(I(X)))ANDH(P(I(X)))ANDHB(P(I(X)))ANDPB(P(I(X)))ANDR(P(I(X)))ANDV(P(I(X))))ORE<>1)THEN?TAB( 15)CN(P(I(X))) TAB( 20)N$(P(I(X))) TAB( 40)T$(P(I(X))) SPC( 6);:ONEGOTO5260,5280,5290,5300,5310,5320,5330
 ...
 5460  IFNOTSCTHENQQ$="Competitor List":?TAB(41-INT ( LEN (QQ$) / 2))QQ$: PRINT : PRINT : PRINT  TAB( 2)"#" TAB( 12)"NAME" TAB( 29)"TEAM" TAB( 39)"FX" SPC( 4)"H" SPC( 5)"R" SPC( 5)"V" SPC( 5)"PB" SPC( 4)"HB" SPC( 4)"AA": PRINT 
 ...
 5500  IFSCTHEN?TAB(23);:&?"##.##",V(I(X));:?TAB( 29);: &? "##.##",PB(I(X));: PRINT  TAB( 35);: &  PRINT "##.##",HB(I(X)): PRINT  TAB( 5);: &  PRINT "##.##",FX(I(X)) + H(I(X)) + R(I(X)) + V(I(X)) + PB(I(X)) + HB(I(X)):? 
 5510  IFNOTSCTHEN?CN(I(X))TAB(5)N$(I(X))TAB(27)T$(I(X))TAB( 37);: &  PRINT "##.##",FX(I(X));: &  PRINT " ##.##",H(I(X));: &?" ##.##",R(I(X));: &  ?" ##.##",V(I(X));: &  ?" ##.##",PB(I(X));: & ? " ##.##",HB(I(X));
