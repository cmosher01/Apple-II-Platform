 ...
 6100  HOME : VTAB 8: HTAB 14: PRINT "END OF PROGRAM": PR# 6
 ...
 10002  IF VT <  INT (12 - NS / 2) + 1 THEN VT =  INT (12 + NS / 2)
 10003  IF VT >  INT (12 + NS / 2) THEN VT =  INT (12 - NS / 2) + 1
 ...
 20010  NEXT : IF  LEN (ZD$) THEN  PRINT  TAB( 41 -  INT ( LEN (ZD$) / 2))ZD$
 20015  PRINT : PRINT : HOME : RETURN 
 20060  HOME : RETURN 
