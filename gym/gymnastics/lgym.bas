 ...
 12  VTAB 4: HTAB 10: PRINT A$;: VTAB 6: HTAB 14: PRINT B$;: VTAB 9: HTAB 20: PRINT "BY";: VTAB 12: HTAB 14: PRINT "RICK" SPC( 5)"CHRIS";: VTAB 13: HTAB 19: PRINT "AND";: VTAB 14: HTAB 13: PRINT "LEWI
 ...
 1999  REM  MENU
 2000 NS = 6:SL$(1) = "ENTER NAMES":SL$(2) = "ENTER SCORES":SL$(3) = "PRINT SCORES":SL$(4) = "MODIFY DATA":SL$(5) = "CATALOG FILES":SL$(6) = "EXIT PROGRAM":TL$ = "GYMNASTICS": GOSUB 10000: ON S GOSUB 
 ...
 4025  VTAB 18: HTAB 16: PRINT "<-- - PREVIOUS": HTAB 16: PRINT "--> - NEXT": VTAB 21: HTAB 13: PRINT "ENTER SCORE WHEN": HTAB 13: PRINT "APPROPRIATE EVENT": HTAB 13: PRINT "IS HIGHLIGHTED": VTAB 8: H
 ...
 5000 NS = 2:SL$(1) = "CLASS/EVENT":SL$(2) = "ALL SCORES":TL$ = "PRINT SCORES": GOSUB 10000:P = S:SL$(1) = "SCREEN":SL$(2) = "PRINTER":TL$ = "": GOSUB 10000: PRINT D$"PR#"S - 1:SC = (S = 1): GOSUB 200
 ...
 5210  PRINT D$"PR#" NOT SC: IF  NOT SC THEN QQ$ = "Class " + C$(C) + "     " + E2$(E): PRINT  TAB( 41 -  INT ( LEN (QQ$) / 2))QQ$: PRINT : PRINT : PRINT  TAB( 16)"#" TAB( 27)"NAME" TAB( 40)"  TEAM   
 ...
 5250  IF  NOT SC AND ((E = 1 AND FX(P(I(X))) AND H(P(I(X))) AND HB(P(I(X))) AND PB(P(I(X))) AND R(P(I(X))) AND V(P(I(X)))) OR E <  > 1) THEN  PRINT  TAB( 15)CN(P(I(X))) TAB( 20)N$(P(I(X))) TAB( 40)T$
 ...
 5460  IF  NOT SC THEN QQ$ = "Competitor List": PRINT  TAB( 41 -  INT ( LEN (QQ$) / 2))QQ$: PRINT : PRINT : PRINT  TAB( 2)"#" TAB( 12)"NAME" TAB( 29)"TEAM" TAB( 39)"FX" SPC( 4)"H" SPC( 5)"R" SPC( 5)"V
 ...
 5500  IF SC THEN  PRINT  TAB( 23);: &  PRINT "##.##",V(I(X));: PRINT  TAB( 29);: &  PRINT "##.##",PB(I(X));: PRINT  TAB( 35);: &  PRINT "##.##",HB(I(X)): PRINT  TAB( 5);: &  PRINT "##.##",FX(I(X)) + 
 5510  IF  NOT SC THEN  PRINT CN(I(X)) TAB( 5)N$(I(X)) TAB( 27)T$(I(X)) TAB( 37);: &  PRINT "##.##",FX(I(X));: &  PRINT " ##.##",H(I(X));: &  PRINT " ##.##",R(I(X));: &  PRINT " ##.##",V(I(X));: &  PR
 ...
 20000  HOME :ZA$ = "SABI COMPETITION":ZB$ = "OLYMPIAD GYMNASTICS CLUB":ZC$ = "Wilmington, Delaware"
 20005 ZE$ = "Dave Hirst Gymnastics Center"
 ...
 20040  PRINT  TAB( 41 -  INT ( LEN (ZD$) / 2))ZD$
 20050  PRINT : PRINT 
 20060  HOME : RETURN 
