...
[source,vbscript]
----
PRINT "CONGRATULATIONS, YOU WIN." : GOTO 150   score 720 (only)
----
...
[source,vbscript]
----
Q = (Y-5)/3  +  RND(3)*SGN(W)*(X<10 AND V<0) : IF Q < 0 THEN Q = 0 :
GOTO 205
----
...
[source,vbscript]
----
FOR I = 1 TO 80 : Q = PEEK(-16336) : NEXT I : GOTO 40
----
