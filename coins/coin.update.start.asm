...
mosk3          tay
               ...
               rts
                               ...
                               ; req'd: vtab, bas
bc                             ; text screen base address calculator (ROM)
                               ;
...
wklp1          lda  readkbd
               ...
               rts
                               ...
                               ; req'd: title, cout, invmask, vtab, bc
...
title                          ; title to display on top line of screen
               ...
               asc             "C o i n   I n v e n t o r y   U p d a t e"
               dfb  $00
